$(function() {
	...
	var page=1;		//더 보기에서 보여줄 페이지르 ㄹ기억할 변수
	...
	function getList(currentPage){ 
		$.ajax({
			type:"post",
			url:"../comment_coffee/list",
			data : {
				"COFFEE_NUM" : $("#board_num").val(), 
				 "page" : currentPage
				 },
			dataType:"json",
			...
			success : function(data){
				...
				if(data == 1){
					$(data.list).each(function() {
						output= ""
					  output += "<tr><td>" + this.tour_SUBJECT +"</td>";
