...
<div class="col-sm-3">
<div class="sidebar">
  <a class="active" href="#home">출 석 체 크</a>
  <a  href="#news">룰 렛 게 임</a>
  <a  href="#contact">포 인 트 스 토 어</a>
 
</div>
</div>	
<div class="container calendar-container col-sm-7"style="position:relative;right:30px">
	<div id="calendar" style="max-width:900px; margin:40px auto; width:100%"></div>
</div>
<div data-v-8e5f91ac="" class="eventWrapContent__right col-sm-2" >
   ...
   <div data-v-8e5f91ac="" class="checkNumber">
   		<span data-v-8e5f91ac="" class="checkinEvent__number__checkin">0</span> 
   	</div>
</div>
</div>
