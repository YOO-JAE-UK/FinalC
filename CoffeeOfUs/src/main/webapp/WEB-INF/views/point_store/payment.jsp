		   ...
		   <c:forEach var="add" items="${addressList}">
		      ...
		      <div class="form-check form-check-inline">
			   <input class="form-check-input" type="radio"
				name="vaddress" id="inlineRadio1" value="${add.raddress}" checked >
				<input type="hidden"  value="${add.rpost}">
				<input type="hidden"  value="${add.rname}">
				<input type="hidden"  value="${add.rtel}">
		    ...
		    <c:if test="${add.rcheck==0}">
		     	<div class="form-check form-check-inline">
			   <input class="form-check-input" type="radio"
				name="vaddress" id="inlineRadio1" value="${add.raddress} " >
				<input type="hidden"  value="${add.rpost}">
				<input type="hidden"  value="${add.rname}">
				<input type="hidden"  value="${add.rtel}">
			   <label class="form-check-label" for="inlineRadio1">${add.rplace}</label>
