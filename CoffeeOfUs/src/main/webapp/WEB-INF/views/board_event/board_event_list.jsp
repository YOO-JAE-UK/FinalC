...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/board_event_list.css" type="text/css">
...
<body>
	...
	<div class="row">
		<div class="col-sm-3">
			<div class="sidebar">
				<a href="attendCheck">커 피 정 보 게 시 판</a> <a class="active" href="#news">출 석 
					게시판</a> <a href="#contact">추 천 음 악 게 시 판</a><a href="#contact">투 어 게 시 판</a>
		...
		<div id="comment">
			<button class="btn btn-warning float-left" style="border:none;width:25%">총 50자까지 가능합니다.</button>
			<%-- <c:if test="${id!=null }"> --%>
			<button class="btn btn-info" style="border:none;margin-left:86px;width:30%" >a님 환영홥니다.</button>
		   <%--  </c:if> --%>
			<button id="write"	class="btn btn-warning float-right" style="border:none;width:10%">등록</button>
		...
		<div class="CommentBox">
		 ...
		 <div class="CommentWriter">
		    <div class="comment_inbox">
		       <b class="comment_inbox_name">a</b> <span 
		...
		<div class="col-sm-2 point" style="float: left;position:relative;top:20px;right:50px"></div>
